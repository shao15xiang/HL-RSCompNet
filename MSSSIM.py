# -*- coding: utf-8 -*-
"""
Created on Wed May  5 17:52:16 2021
...
class MS_SSIM(torch.nn.Module):
    ...
    def _ssim(self, img1, img2, size_average = True):
        ...
        window = create_window(window_size, sigma, self.channel).cuda(self.device_id)
    ...
    def ms_ssim(self, img1, img2, levels=5):
        ...
        weight = Variable(torch.Tensor([0.0448, 0.2856, 0.3001, 0.2363, 0.1333]).cuda(self.device_id))

        msssim = Variable(torch.Tensor(levels,).cuda(self.device_id))
        mcs = Variable(torch.Tensor(levels,).cuda(self.device_id))
...
if __name__ =='__main__':
    ...
    img1 = '/home/xs/semantic-Weighted-Compression/images_p5/6_6_recon.jpg'
    img2 = '/home/xs/semantic-Weighted-Compression/images_p5/6_6_recon.jpg'
    bpp = get_bpp(img1, img2, 256,256)
    print(bpp)
